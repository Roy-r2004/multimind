    ...
    def model_answer_prompt(
        ...
        *,
        ...
        return self.render(
            ...
            # Council behavior is fixed: user-editable Verdict instructions are
            # deliberately unavailable to this render path.
            custom_instructions=None,
            template_instructions=None,
            council_runtime_context=council_runtime_context,
