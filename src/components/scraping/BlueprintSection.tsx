export function BlueprintSection({
  ...
  return (
    <section className="dream-rise relative overflow-hidden rounded-[1.35rem] border border-white/10 bg-[#0b161c]/75 p-5 shadow-[0_16px_40px_rgba(0,0,0,0.18)] backdrop-blur-md">
      <div
        aria-hidden
