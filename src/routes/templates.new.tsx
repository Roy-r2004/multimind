...
function NewTemplate() {
  ...
  const [instructions, setInstructions] = useState(
    "Explain like I'm new to the topic. Use simple words and short examples.",
  );
          ...
          <div className="space-y-4">
            ...
            <label className="block text-sm">
              ...
              <select
                ...
                className="w-full rounded-lg border border-border bg-background px-3 py-2 text-sm"
              >
                {["Learning", "Business", "Decision", "Coding", "Writing"].map((c) => (
          ...
          <div>
            ...
            <div className="rounded-2xl border border-border bg-card p-4 text-sm">
              ...
              <div className="mt-2 rounded-lg bg-accent/40 p-3 text-foreground/90">
                <strong>[{name}]</strong> {instructions} — Now answer: “How does compound interest
                work?”
              </div>
            </div>
          </div>
